...
describe("When I am on NewBill Page", () => {
  ...
  describe ("When I am on NewBill form", () => {
    test("Then an invalid file extension quit the fonction", async () => {
      ...
      const billCreate = jest.fn(dashboard.store.bills().create);
      ...
      // Assurez-vous que handleChangeFile est appelée lors du changement de fichier
      expect(handleChangeFile).toHaveBeenCalled();
      //expect(billCreate).toHaveBeenCalled();

      // Cas où le fichier à une mauvaise extension
      expect(billCreate).not.toHaveBeenCalled();

      // Vérification d'un élément de texte dans le DOM après le changement de fichier
